...
import { Smartphone, Globe, PenTool, Rocket, Zap, Award } from 'lucide-react';
  ...
  const services: Service[] = [
    {
      ...
      description: "Cross-platform applications built with Flutter for Android and iOS with beautiful UI and seamless performance.",
      color: "bg-gradient-to-br from-blue-500/20 to-purple-500/20"
    },
    {
      icon: <Globe size={24} />,
      title: "Web Development",
      description: "Responsive, modern websites and web applications designed to impress and engage your audience.",
      color: "bg-gradient-to-br from-green-500/20 to-teal-500/20"
    },
    {
      icon: <PenTool size={24} />,
      title: "Social Media Advertising",
      description: "Strategic campaigns that increase brand awareness and drive conversions across social platforms.",
      color: "bg-gradient-to-br from-pink-500/20 to-red-500/20"
    },
    {
      icon: <Rocket size={24} />,
      title: "App Performance Optimization",
      description: "Enhance your existing app's speed, stability and user experience for maximum engagement.",
      color: "bg-gradient-to-br from-amber-500/20 to-orange-500/20"
    },
    {
      icon: <Zap size={24} />,
      title: "Firebase Integration",
      description: "Seamless setup and management of Firebase services for authentication, storage, and real-time databases.",
      color: "bg-gradient-to-br from-cyan-500/20 to-blue-500/20"
    },
    {
      icon: <Award size={24} />,
      title: "UI/UX Consultancy",
      description: "Expert advice on improving user interfaces and experiences to create intuitive, engaging applications.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 mt-4 max-w-2xl mx-auto">
            I offer a comprehensive range of digital services to help businesses and 
        ...
        <div className="mt-16 bg-space-blue/40 rounded-lg p-8 border border-space-purple/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">
              ...
              Whether you have a specific requirement or need guidance on your 
              digital journey, feel free to reach out.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6">
            <Card className="glass-card border-space-purple/20">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold">Fast Turnaround</h4>
            ...
            <Card className="glass-card border-space-purple/20">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold">Quality Guaranteed</h4>
                  <p className="text-gray-400 text-sm">Clean code and beautiful interfaces</p>
                </div>
              </CardContent>
            </Card>
          </div>
